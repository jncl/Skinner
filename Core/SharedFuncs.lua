...
local buildInfo = {
	...
	wow_classic_ptr     = {"3.4.0",  46368, "Classic PTR"},
	wow_classic_era_ptr = {"1.14.3", 45437, "Classic Era PTR"}, -- a.k.a. Season of Mastery PTR
	wow_beta            = {"10.0.2", 46259, "Retail Beta"}, -- a.k.a. Dragonflight
	wow_ptr             = {"10.0.0", 46366, "Retail PTR"},
	-- Live
	wow_classic         = {"3.4.0",  46248, "Classic"}, -- a.k.a. Wrath of the Lich King Classic
	wow_classic_era     = {"1.14.3", 45437, "Classic Era"},
	wow                 = {"10.0.0", 46366, "Retail"},
	-- Currently playing
