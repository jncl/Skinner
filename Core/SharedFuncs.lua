...
local buildInfo = {
	wow_classic         = {"4.4.0",  54851, "Classic"}, -- a.k.a. Wrath of the Lich King Classic
	wow_classic_beta    = {"4.4.0",  54737, "Cataclysm Classic Beta"},
	wow_classic_era     = {"1.15.2", 54649, "Classic Era"}, -- a.k.a. Season of Discovery
	wow_classic_era_ptr = {"1.15.2", 54067, "Classic Era PTR"},
	wow_classic_ptr     = {"4.4.0",  54851, "Classic PTR"},
	-- wow_beta            = {"11.0.0", 56000, "Retail Beta"}, -- a.k.a. The War Within
	wow_ptr             = {"10.2.7", 54904, "Retail PTR"},
	wow                 = {"10.2.7", 54847, "Retail"},
