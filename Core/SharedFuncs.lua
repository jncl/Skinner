...
local buildInfo = {
	...
	wow_classic_ptr     = {"3.4.3",  51397, "Classic PTR"},
	wow_classic_era_ptr = {"1.14.4", 51146, "Classic Era PTR"},
	wow_ptr_x           = {"10.2.0", 51297, "Retail PTRX"}, -- [wowxptr]
	wow_ptr             = {"10.1.7", 51313, "Retail PTR"},
	-- Live
	wow_classic         = {"3.4.2",  50664, "Classic"}, -- a.k.a. Wrath of the Lich King Classic
	wow_classic_era     = {"1.14.4", 51311, "Classic Era"},
	wow                 = {"10.1.7", 51313, "Retail"},
	-- Currently playing
