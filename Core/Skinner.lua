...
function aObj:OnInitialize()
	...
	if self.isRetBeta then self:Debug("Retail_Beta detected")
	elseif self.isRetPTR then self:Debug("Retail_PTR detected")
	elseif self.isRet then self:Debug("Retail detected") end
