...
aObj.blizzFrames[ftype].ChatConfig = function(self)
	...
	self:SecureHookScript(_G.ChatConfigFrame, "OnShow", function(this)
		self:removeNineSlice(this.Border)
		self:skinObject("frame", {obj=_G.ChatConfigCategoryFrame, fType=ftype, kfs=true, fb=true, ofs=0})
		self:skinObject("frame", {obj=_G.ChatConfigBackgroundFrame, fType=ftype, kfs=true, fb=true, ofs=0})
		...
		self:skinObject("frame", {obj=_G.ChatConfigCombatSettingsFilters, fType=ftype, kfs=true, fb=true, ofs=0})
...
aObj.blizzLoDFrames[ftype].GarrisonUI = function(self)
	...
	self:SecureHookScript(_G.GarrisonBuildingFrame, "OnShow", function(this)
		...
		self:SecureHookScript(_G.GarrisonBuildingFrame.BuildingList, "OnShow", function(this)
			...
			self:skinObject("tabs", {obj=this, tabs=this.Tabs, fType=ftype, lod=self.isTT and true, upwards=true, regions={1, 3}, offsets={x1=7, y1=-7, x2=-7, y2=self.isTT and 2 or 7}, track=false, func=aObj.isTT and function(tab)
...
aObj.blizzFrames[ftype].HelpFrame = function(self)
	...
	self:SecureHookScript(_G.HelpFrame, "OnShow", function(this)
		...
		self:skinObject("frame", {obj=this, fType=ftype, kfs=true, hdr=true, ri=true, rns=true, cb=true, x2=3})
...
aObj.blizzFrames[ftype].InterfaceOptions = function(self)
	...
	self:SecureHookScript(_G.InterfaceOptionsFrame, "OnShow", function(this)
		...
		-- RHS Panel
		self:skinObject("frame", {obj=_G.InterfaceOptionsFramePanelContainer, fType=ftype, kfs=true, fb=true, ofs=-1, y2=0})
	...
	if self.prdb.MainMenuBar.skin then
		...
		if self.modBtnBs then
			for i = 1, _G.NUM_STANCE_SLOTS do
				self:addButtonBorder{obj=_G["StanceButton" .. i], abt=true, sec=true} -- N.B. uses SecureFrameTemplate
			end
			...
			for i = 1, _G.NUM_PET_ACTION_SLOTS do
				...
				self:addButtonBorder{obj=_G[bName], abt=true, sec=true, ofs=3, reParent={_G[bName .. "AutoCastable"], _G[bName .. "SpellHighlightTexture"]}} -- N.B. uses SecureFrameTemplate
			...
			for i = 1, #_G.MICRO_BUTTONS do
				...
				self:addButtonBorder{obj=mBut, es=24, ofs=2, reParent=mBut == "MainMenuMicroButton" and {mBut.Flash, _G.MainMenuBarPerformanceBar, _G.MainMenuBarDownload} or {mBut.Flash}, clr="grey"}
			end
			mBut = nil
			-- skin bag buttons
