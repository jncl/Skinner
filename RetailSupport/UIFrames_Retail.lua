...
aObj.SetupRetail_UIFramesOptions = function(self)
	...
	local optTab = {
		...
		["Behavioral Messaging"]         = {desc = "Behavioral Messaging Frames", width = "double"},
		["Calendar"]                     = true,
		["Challenges UI"]                = true,
		["Character Customize"]          = {desc = "Character Customize Frame", width = "double"},
		["Chat Channels UI"]             = true,
		["Class Trial"]                  = {desc = "Class Trial Frames"},
		["Console"]                      = {desc = "Developer Console Frame", width = "double"},
		["Contribution"]                 = {desc = "Contribution Frame"},
		["Covenant Toasts"]              = true,
		["Death Recap"]                  = {desc = "Death Recap Frame"},
		["Destiny Frame"]                = true,
		["Event Toast Manager"]          = {desc = "Event Toast Manager Frame", width = "double"},
		["Garrison UI"]                  = true,
		["Ghost Frame"]                  = true,
		...
		["Loss Of Control"]              = {desc = "Loss Of Control Frame"},
		["Navigation Bar"]               = true,
