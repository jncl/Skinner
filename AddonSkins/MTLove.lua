...
function Skinner:MTLove()
	...
	self:RawHook(MTLove_Frame, "SetBackdropColor", function() end, true)
	self:RawHook(MTLove_Frame, "SetBackdropBorderColor", function() end, true)
	self:applySkin(MTLove_Frame_Counter)
	self:RawHook(MTLove_Frame_Counter, "SetBackdropColor", function() end, true)
	self:RawHook(MTLove_Frame_Counter, "SetBackdropBorderColor", function() end, true)
	self:glazeStatusBar(MTLove_Frame_StatusBar0, 0)
	self:glazeStatusBar(MTLove_Frame_StatusBar1, 0)
	self:applySkin(MTLove_TT_Frame)
	self:RawHook(MTLove_TT_Frame, "SetBackdropColor", function() end, true)
	self:RawHook(MTLove_TT_Frame, "SetBackdropBorderColor", function() end, true)
	self:glazeStatusBar(MTLove_TT_Frame_StatusBar, 0)
	self:applySkin(MTLove_TT_Frame_Counter)
	self:RawHook(MTLove_TT_Frame_Counter, "SetBackdropColor", function() end, true)
	self:RawHook(MTLove_TT_Frame_Counter, "SetBackdropBorderColor", function() end, true)
	self:applySkin(MTLove_TargetCounter_Counter)
	self:RawHook(MTLove_TargetCounter_Counter, "SetBackdropColor", function() end, true)
	self:RawHook(MTLove_TargetCounter_Counter, "SetBackdropBorderColor", function() end, true)
