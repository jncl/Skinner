...
-->>--	Detail Frame
	...
	self:Hook(QuestHistoryDetailRewardTitleText, "SetTextColor", function() end, true)
	QuestHistoryDetailItemChooseText:SetTextColor(self.BTr, self.BTg, self.BTb)
	self:Hook(QuestHistoryDetailItemChooseText, "SetTextColor", function() end, true)
	QuestHistoryDetailItemReceiveText:SetTextColor(self.BTr, self.BTg, self.BTb)
	self:Hook(QuestHistoryDetailItemReceiveText, "SetTextColor", function() end, true)
