...
-->>-- Tabs (side)
	...
	self:skinAllButtons{obj=BindPadFrame}
	self:addSkinFrame{obj=BindPadFrame, kfs=true, x1=10, y1=-11, x2=-32, y2=71}
-->>-- Bind frame
	self:skinAllButtons{obj=BindPadBindFrame}
...
-->>-- Macro Popup frame
	...
	self:skinAllButtons{obj=BindPadMacroPopupFrame}
...
-->>-- Macro Text frame
	...
	self:skinAllButtons{obj=BindPadMacroTextFrame}
