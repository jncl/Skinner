...
aObj.addonsToSkin.SoulshapeJournal = function(self) -- v 0.8
	...
	self:SecureHookScript(_G.SoulshapeCollectionPanel, "OnShow", function(this)
		...
		if not this.sf then
			...
			self:skinObject("editbox", {obj=self:getChild(this, 9), si=true})
			...
			if self.modBtns then
				self:skinStdButton{obj=self:getChild(this, 11)}
			end
