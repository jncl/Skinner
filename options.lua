...
aObj.blizzFrames[ftype].SetupDefaults = function(self)
	...
	-- NPC Frames
		...
		BlackMarketUI              = true,
		ChromieTimeUI              = aObj.isBeta and true or nil,
		...
		ItemUpgradeUI              = true,
		MerchantFrame              = true,
		NewPlayerExperienceGuide   = aObj.isBeta and true or nil,
		Petition                   = true,
		PetStableFrame             = true,
	...
	-- UI Frames
		...
		AdventureMap               = true,
		AlertFrames                = true,
		AnimaDiversionUI           = aObj.isBeta and true or nil,
		AutoComplete               = true,
		BattlefieldMap             = true,
		BNFrames                   = true,
		Calendar                   = true,
		...
		Nameplates                 = true,
		NavigationBar              = true,
		NewPlayerExperience        = aObj.isBeta and true or nil,
		ObliterumUI                = true,
		OrderHallUI                = true,
		PetBattleUI                = true,
		...
		SubscriptionInterstitialUI = aObj.isBeta and true or nil,
		SplashFrame                = true,
		StaticPopups               = true,
		TalkingHeadUI              = true,
		TimeManager                = true,
		Tooltips                   = {skin = true, style = 1, glazesb = true, border = 1},
		TorghastLevelPicker        = aObj.isBeta and true or nil,
		Tutorial                   = true,
		UIWidgets                  = true,
		UnitPopup                  = true,
	...
	self.optTables = {
		...
		["NPC Frames"] = {
			...
			args = {
				...
				ChromieTimeUI = aObj.isBeta and {
					type = "toggle",
					name = self.L["Chromie Time UI"],
					desc = self.L["Toggle the skin of the Chromie Time UI"],
				} or nil,
				...
				NewPlayerExperienceGuide = aObj.isBeta and {
					type = "toggle",
		...
		["UI Frames"] = {
			...
			args = {
				...
				AnimaDiversionUI =  aObj.isBeta and {
					type = "toggle",
					name = self.L["Anima Diversion UI"],
					desc = self.L["Toggle the skin of the Anima Diversion UI"],
				} or nil,
				AutoComplete = {
					type = "toggle",
				...
				NewPlayerExperience = aObj.isBeta and {
					type = "toggle",
					name = self.L["New Player Experience"],
					desc = self.L["Toggle the skin of the New Player Experience"],
				} or nil,
				ObliterumUI = {
					type = "toggle",
				...
				SubscriptionInterstitialUI = aObj.isBeta and {
					type = "toggle",
					name = self.L["Subscription Interstitial UI"],
					desc = self.L["Toggle the skin of the Subscription Interstitial UI"],
				} or nil,
				SplashFrame = {
					type = "toggle",
				...
				TorghastLevelPicker = aObj.isBeta and {
					type = "toggle",
					name = self.L["Torghast Level Picker Frame"],
					desc = self.L["Toggle the skin of the Torghast Level Picker Frame"],
				} or nil,
				Tutorial = {
					type = "toggle",
