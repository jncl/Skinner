...
--	self:Debug("BlizzardFrames")
	...
	local blizzFrames = {
		...
		"FriendsFrame", "TradeFrame", "ResizeQW", "Buffs", "AchievementWatch",
...
--	self:Debug("AddonFrames")
	...
	local addonFrames = {
		"Accountant", "Ace2", "AceProfit", "AckisRecipeList", "ACP", "AdvancedTradeSkillWindow", "aftt_extreme", "AlphaMap", "Altoholic", "AoTRDungeonQuester", "ArkInventory", "Armory", "Ash_Cooldowns", "Ash_Core", "Ash_DoTimer", "Assessment", "Atlas", "AtlasLoot", "AtlasQuest", "AuldLangSyne", "AuldLangSyne_Note", "AutoDecline", "AutoProfit", "AutoProfitX", "AxuItemMenus",
		...
		"MacroBank", "MageEatDrinkAid", "MailTo", "MCP", "MetaMap", "MinimapButtonFrame", "Mirror", "MobileFrames", "MobileVault", "MobMap", "Moleskine", "MonkeyQuest", "MonkeyQuestLog", "MTLove", "MultiTips", "MusicPlayer", "MyBags", "myBindings", "myClock", "myMusic",
		"NeonChat", "Notebook", "NotesUNeed", "nQuestLog",
		"Omen", "Omnibus", "OneBag", "oRA2", "Outfitter",
		...
		"Talented", "Tankadin", "TankPoints", "TargetAnnounce", "tekDebug", "tekErr", "tekKompare", "TinyTip", "TipBuddy", "TipTac", "TitanExitGame", "TomTom", "Toons", "TourGuide", "TradeJunkie", "Trinity2", "TrinityBars2", "TuringTest",
