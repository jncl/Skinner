...
--	self:Debug("AddonFrames")
	...
	local addonFrames = {
		...
		"Capping", "Cartographer", "Cartographer_QuestInfo", "CBRipoff", "CEnemyCastBar", "CharactersViewer", "Chatr", "Chatter", "Chinchilla", "Clique", "Combuctor", "ConcessionStand", "Converse", "CowTip", "CT_MailMod", "CT_RaidAssist", "CT_RaidTracker",
		...
		"Hadar_FocusFrame", "HatTrick", "HealBot", "HealersAssist", "HealingEstimator", "HealOrganizer", "Historian", "HitsMode", "HoloFriends",
